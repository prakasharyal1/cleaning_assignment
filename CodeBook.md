Code Book
This code book includes information about the source data, the transformations performed after collecting the data and  information about the variables of  resulting data sets.

Design

The source data was collected from the UCI Machine Learning Repository to complete an assignment for Getting and Cleaning Data instructed by Jeff Leek. The assignment involved working with the data set and producing tidy data representation of the source data. Below is a list of the operations done to achieve the outputs.

Downloaded data set
Unzipped data into chosen working directory
...
Created another data set using the data.table library to group the tidy data by subject and activity
Applied the mean and standard deviation calculations across the groups
Produced "calculated_tidy_data.txt" as the second output
Please refer to run_analysis.R.
